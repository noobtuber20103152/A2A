...
const movieAgentCard: AgentCard = {
  name: process.env.AGENT_NAME || "Movie AI Agent",
  description:
    "A specialized agent that can provide movie reviews, ratings, recommendations, and detailed analysis of films, actors, directors, and genres.",
  ...
  skills: [
    {
      id: "movie_reviews_chat",
      name: "Movie Reviews & Recommendations",
      description:
        "Assist with reviewing movies, providing ratings, giving personalized suggestions, analyzing plot, themes, actors, directors, and recommending similar films.",
      tags: ["movies", "reviews", "ratings", "recommendations", "actors", "directors", "genres"],
      examples: [
        "Give a detailed review and rating for Inception.",
        "Suggest movies similar to The Dark Knight for someone who loves action thrillers.",
        "Provide pros and cons for watching Titanic.",
        "Recommend a list of feel-good comedy films for the weekend.",
        "Explain the plot and themes of Parasite.",
        "Which new releases this month are worth watching on Netflix?",
        "Suggest classic movies directed by Steven Spielberg.",
      ],
